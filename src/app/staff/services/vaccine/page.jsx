...
export default function VaccineServicePage() {
  ...
  useEffect(() => {
    ...
    if (data) {
      try {
        ...
        const filtered = all.filter((b) =>b.service.toLowerCase().trim() === 'vaccine');
  ...
  return (
    <div className="min-h-screen bg-[#fffaf5] p-8 font-sans">
      <h1 className="text-2xl font-bold text-orange-500 mb-4">Booking Layanan: Vaccine</h1>
